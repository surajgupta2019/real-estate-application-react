...
export default function Profile() {
  ...
  async function onsubmit(){
     try {
      ...
      toast.success('Proflie details updated')
     } catch (error) {
  ...
  useEffect(()=>{
    async function fetchUserListings(){
      ...
      auth.currentUser.uid), orderBy("timestamp", "desc")
      );
     ...
     <section className="max-w-6xl mx-auto flex justify-center items-center flex-col">
      ...
      <div className="w-full md:w-[50%] mt-6 px-3"> 
        <form>
          ...
          onChange={onChange} className={`mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out ${changeDetail && "bg-red-200 focus:bg-red-200"}`} />
          ...
          <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6">
            ...
            className="text-red-600 hover:text-red-700 transition ease-in-out duration-20 ml-1 cursor-pointer">
